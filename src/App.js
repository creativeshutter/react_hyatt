        ...
        <header id="intro">
          ...
          <nav id="nav">
            <div className="navbar">
              <div className="brand"><a href="#welcome">Hyatt <span>Hotel</span></a></div>
              <ul>
        ...
        <main id="wrapper">
          <div className="scene" id="welcome">
            <article className="content">
              ...
              <h1>Welcome to the Hyatt&nbsp;Hotel</h1>
              <p>The original Hyatt perseveres after 50 years in the heart of West London. The West End neighborhood has something for everyone—from theater to dining to historic sights. And the not-to-miss Rooftop Cafe is a great place for travelers and locals to engage over drinks, food, and good&nbsp;conversation. &nbsp;To learn more about the Hyatt Hotel in the West End, browse our website and <a href="files/landon_information_sheet_London.pdf">download our handy information sheet</a>.</p>
            </article>
          </div>
